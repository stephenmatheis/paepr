...
export default function Component_Feedback(param) {
    ...
    const component = Component({
        ...
        style: /*css*/ `
            ...
            #id .new-comment:focus{
                outline: none;
                border-left: solid 1px ${App.primaryColor};
                border-top: solid 1px ${App.primaryColor};
                border-bottom: solid 1px ${App.primaryColor};
            }
            ...
            #id .new-comment:focus ~ .new-comment-button-container {
                border-radius: 0px 4px 4px 0px;
                border-right: solid 1px ${App.primaryColor};
                border-top: solid 1px ${App.primaryColor};
                border-bottom: solid 1px ${App.primaryColor};
            }
            ...
            #id .comment-container.mine .comment {
                background: rgba(${App.primaryColorRGB}, .14);
    ...
    function commentTemplate(comment, isNew) {
        return /*html*/ `
            <div class='comment-container${comment.Account === App.user.Account ? ' mine' : ''}${isNew ? ' animate-new-comment' : ''}' data-itemid='${comment.Id}'>
                <div class='comment'>
                    <div class='comment-date-container'>
                        ${comment.Account !== App.user.Account ? /*html*/`<div class='comment-author'>${comment.SubmittedBy}</div>` : ''}
