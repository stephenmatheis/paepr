    ...
    const component = Component({
        ...
        style: /*css*/ `
            ...
            #id.slide-container img {
                ...
                border-radius: 8px;
                box-shadow: 7px 7px 0px 0px ${App.primaryColor};
            }
        ...
        events: [
                ...
                listener(event) {
                    const poll = setInterval( async () => {
                        ...
                        if (serverVersion > clientVersion) {
                            /** Replace item */
                            const index = App.data.lists[library].indexOf(slide);
                            App.data.lists[library].splice(index, 1, item);
            ...
            },
            {
                ...
                async listener(event) {
                    ...
                    if (files.length > 0) {
                        App.store.get('maincontainer').dim(true);
                        ...
                        App.store.get('maincontainer').dim(false);
                    }
                }
            },
            // {
